...
LED_STRIPE_LED_WIDTH = 8; // The stripes are soldered together, at those points the distance between leds is a lot higher
LED_STRIPE_LED_HEIGHT = 8;

LED_STRIPE_CAP_WIDTH = 3;
LED_STRIPE_CAP_HEIGHT = 5;
LED_STRIPE_CAP_DEPTH = 1.2;
...
LETTER_PLATE_SCREW_INSERT_HEIGHT = 3.5;
...
TOTAL_DEPTH = LETTER_SEPARATOR_HEIGHT + LED_HOLDER_PLATE_HEIGHT;
...
CORNER_MOUNTING_HOLE_OFFSET = 0.5;
