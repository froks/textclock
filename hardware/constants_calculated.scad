...
HORIZ_SIDE_EXTRA = LETTER_MATRIX_HEIGHT>LETTER_MATRIX_WIDTH ? ((LETTER_MATRIX_HEIGHT-LETTER_MATRIX_WIDTH)*LED_STRIPE_HORIZ_DISTANCE)/2 : 0 + CONFIG_HORIZ_EXTRA;
VERT_SIDE_EXTRA = LETTER_MATRIX_WIDTH>LETTER_MATRIX_HEIGHT ? ((LETTER_MATRIX_WIDTH-LETTER_MATRIX_HEIGHT)*LED_STRIPE_VERT_DISTANCE)/2 : 0 + CONFIG_VERT_EXTRA;
