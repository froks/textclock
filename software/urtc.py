# from https://github.com/adafruit/Adafruit-uRTC
# MIT License 
...
def datetime_tuple(year=None, month=None, day=None, hour=None,
                   minute=None, second=None, millisecond=None, weekday=None):
